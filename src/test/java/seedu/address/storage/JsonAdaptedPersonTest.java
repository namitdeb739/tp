...
public class JsonAdaptedPersonTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedTenant person = new JsonAdaptedTenant(INVALID_NAME, INVALID_NAME, /*
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedTenant person =
                new JsonAdaptedTenant(null, null, /* VALID_PHONE, VALID_EMAIL, */ VALID_ADDRESS/* , VALID_TAGS */);
    ...
    // JsonAdaptedTenant person = new JsonAdaptedTenant(VALIDGI, /*
    ...
    // JsonAdaptedTenant person =
    // new JsonAdaptedTenant(VALID_NAME, /* null, VALID_EMAIL, */ VALID_ADDRESS/* , VALID_TAGS */);
    ...
    // JsonAdaptedTenant person =
    // new JsonAdaptedTenant(VALID_NAME, /* VALID_PHONE, null, */ VALID_ADDRESS/* , VALID_TAGS */);
    // String expectedMessage = String.format(MISSING_FIELD_MESSAGE_FORMAT,
    ...
    public void toModelType_invalidAddress_throwsIllegalValueException() {
        JsonAdaptedTenant person = new JsonAdaptedTenant(VALID_GIVEN_NAME, VALID_FAMILY_NAME, /*
                                                                                               * VALID_PHONE,
                                                                                               * VALID_EMAIL,
                                                                                               */
