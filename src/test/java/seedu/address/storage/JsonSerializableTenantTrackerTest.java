...
public class JsonSerializableTenantTrackerTest {
    ...
    // JsonSerializableTenantTracker dataFromFile =
    // JsonUtil.readJsonFile(DUPLICATE_PERSON_FILE, JsonSerializableTenantTracker.class).get();
    // assertThrows(IllegalValueException.class, JsonSerializableTenantTracker.MESSAGE_DUPLICATE_PERSON,
