...
public class EditCommand extends Command {
    ...
    public String toString() {
        return new ToStringBuilder(this).add("index", index)
                .add("editTenantDescriptor", editTenantDescriptor).toString();
    }
    ...
    public static class EditTenantDescriptor {
        ...
        // /**
        // * Sets {@code tags} to this object's {@code tags}. A defensive copy of {@code tags} is
        // used
        // * internally.
        // */
