...
public class EditCommand extends Command {
    ...
    public static final String MESSAGE_USAGE = COMMAND_WORD + ": Edits the details of the person identified "
            ...
            + PREFIX_FAMILY_NAME + "FAMILY NAME] " + "[" + PREFIX_PHONE + "PHONE] " + "[" + PREFIX_EMAIL + "EMAIL] "
    ...
    public CommandResult execute(Model model) throws CommandException {
        ...
        return buildCommandResult(String.format(MESSAGE_EDIT_PERSON_SUCCESS, Messages.format(editedTenant)));
    }
    ...
    private static Tenant createEditedPerson(Tenant personToEdit, EditTenantDescriptor editPersonDescriptor) {
        ...
        return new Tenant(updatedName, updatedPhone, updatedEmail, updatedAddress, updatedTags);
    }
     ...
     */
    public static class EditTenantDescriptor {
        private Name name;
        private Phone phone;
        private Email email;
         ...
         */
        public EditTenantDescriptor(EditTenantDescriptor toCopy) {
            setName(toCopy.name);
        ...
        public boolean equals(Object other) {
            ...
            // instanceof handles nulls
            if (!(other instanceof EditTenantDescriptor)) {
                return false;
            }
