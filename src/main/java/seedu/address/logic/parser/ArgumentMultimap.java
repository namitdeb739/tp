...
public class ArgumentMultimap {
    ...
    /**
     * Returns all values of {@code prefix}. If the prefix does not exist or has no values, this will
     * return an empty list. Modifying the returned list will not affect the underlying data structure
     * of the ArgumentMultimap.
     */
    ...
    /**
     * Throws a {@code ParseException} if any of the prefixes given in {@code prefixes} appeared more
     * than once among the arguments.
     */
