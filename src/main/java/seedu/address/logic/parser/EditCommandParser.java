...
public class EditCommandParser implements Parser<EditCommand> {
    ...
    public EditCommand parse(String args) throws ParseException {
        requireNonNull(args);
        ArgumentMultimap argMultimap = ArgumentTokenizer.tokenize(args, PREFIX_GIVEN_NAME,
                PREFIX_FAMILY_NAME/* , PREFIX_PHONE, PREFIX_EMAIL */,
        ...
        argMultimap.verifyNoDuplicatePrefixesFor(PREFIX_GIVEN_NAME,
                PREFIX_FAMILY_NAME/* , PREFIX_PHONE, PREFIX_EMAIL */, PREFIX_ADDRESS);
        ...
        if (argMultimap.getValue(PREFIX_GIVEN_NAME).isPresent()) {
            editPersonDescriptor
                    .setName(ParserUtil.parseName(argMultimap.getValue(PREFIX_GIVEN_NAME).get(),
